...
aprun -n 1 -N 1 --cc depth -e OMP_NUM_THREADS=64 -d 64 python resnet50_hvd.py --output_folder results/n1.g1.w8.c/$TAG/ --profile --num_workers 8 --epochs 5 --steps 100 --custom_data_loader
aprun -n 4 -N 4 --cc depth -e OMP_NUM_THREADS=16 -d 16 python resnet50_hvd.py --output_folder results/n1.g4.w8.c/$TAG/ --profile --num_workers 8 --epochs 5 --steps 100 --custom_data_loader
